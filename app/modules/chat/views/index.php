...
<li class="listu"><?php echo $user['nickname'];
 ...
 ?><span class="addfriends" onclick="ajaxLoad('/friends/sendRequest', 'reqest', 'pid:<?php echo $user['id'];?>');" style="cursor:pointer;">add friend</span> <?php } ?></li>
<?php  
...
<div class="chatMain">
	...
	jQuery(function()
	{
		...
		jQuery.ajax({url: "/chat/useronliner", success: function(result){
        jQuery(".online").html(result);
    }}); }, 3000);
	})
